...
export default function Tier({ member, points, place, className }: TierProps) {
  ...
  return (
    <div className={cn({
      'bg-linear-to-br from-amber-600 to-amber-700 h-20': place === 'Bronze',
      'bg-linear-to-br from-zinc-300 to-zinc-400 h-24': place === 'Silver',
      'bg-linear-to-br from-amber-300 to-amber-500 h-32': place === 'Gold',
