...
export default function Tier({ member, points, place, className }: TierProps) {
  ...
  return (
    <div className='flex flex-col gap-1 items-center justify-end max-w-80 w-full h-[90%]'>
      ...
      <h3 className={cn(
        'h-fit bg-secondary/80 rounded bottom-full text-pretty z-10 px-2',
      ...
      <div className={cn(
        ...
        {
          'bg-linear-to-br from-amber-600 to-amber-700 h-1/3 border-amber-700/50': place === 'Bronze',
          'bg-linear-to-br from-zinc-300 to-zinc-400 h-3/5 border-zinc-400/50': place === 'Silver',
