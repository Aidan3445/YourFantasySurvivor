...
export default function LeagueNav() {
  ...
  return (
    <nav className='absolute top-16 left-8 sm:left-[72px] md:top-2 md:left-96 lg:left-[504px] xl:left-auto grid grid-cols-2 gap-2 p-2 text-black rounded-2xl border-2 border-black bg-b1'>
