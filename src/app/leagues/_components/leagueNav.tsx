...
export default function LeagueNav() {
  ...
  return (
    <nav className='grid absolute left-8 top-16 grid-cols-2 gap-2 p-2 text-black rounded-2xl border-2 border-black md:top-2 md:left-96 bg-b1 sm:left-[72px] lg:left-[504px] xl:left-[584]'>
